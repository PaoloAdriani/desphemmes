...
<#macro page_body>
     ...
     <section id="slider" class="slider-element mt-3">
        <div class="masonry-thumbs grid-container row row-cols-6" data-big="3" data-lightbox="gallery">
            <#list 1..21 as i>
                <a class="grid-item" href="<@ofbizContentUrl>${assetspath}/images/campaign/adv2025/adv25_${i}.jpg</@ofbizContentUrl>" data-lightbox="gallery-item">
                    <div class="grid-inner">
                        <img src="<@ofbizContentUrl>${assetspath}/images/campaign/adv2025/adv25_${i}.jpg</@ofbizContentUrl>" alt="Gallery Thumb 1">
