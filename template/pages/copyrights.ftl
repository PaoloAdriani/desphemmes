		...
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-md-6 d-md-flex flex-md-column align-items-md-end mt-4 mt-md-0">
				<ul class="list-unstyled d-flex flex-row mb-2">
					...
					<li class="me-2"><img src="<@ofbizContentUrl>${assetspath}/store/xmas/images/cards/pp.svg</@ofbizContentUrl>" alt="PayPal" width="34"></li>
					<li class="me-2"><img src="<@ofbizContentUrl>${assetspath}/store/xmas/images/cards/sk.svg</@ofbizContentUrl>" alt="Skrill" width="34"></li>
					<li class="me-2"><img src="<@ofbizContentUrl>${assetspath}/store/xmas/images/cards/2co.svg</@ofbizContentUrl>" alt="2CheckOut" width="34"></li>
					<li class="me-2"><img src="<@ofbizContentUrl>${assetspath}/store/xmas/images/cards/wu.svg</@ofbizContentUrl>" alt="Western Union" width="34"></li>
				</ul>
