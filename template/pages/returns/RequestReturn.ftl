                    ...
                    <div class="screenlet-title-bar">
                        <div class="boxlink">
                          <#if maySelectItems?default(false)>
                              <a href="javascript:document.addCommonToCartForm.add_all.value='true';document.addCommonToCartForm.submit()" class="submenutext">${SystemLabelMap.OrderAddAllToCart}</a><a href="javascript:document.addCommonToCartForm.add_all.value='false';document.addCommonToCartForm.submit()" class="submenutextright">${SystemLabelMap.OrderAddCheckedToCart}</a>
                          </#if>
                        </div>
                        <div class="h3">${SystemLabelMap.OrderReturnItems}</div>
                    </div>
                    <div class="screenlet-body">
                        <form name="selectAllForm" method="post" action="<@ofbizUrl>requestReturn</@ofbizUrl>">
                          ...
                          <table border="0" width="100%" cellpadding="2" cellspacing="0">
                            <tr>
                              <td colspan="5"><h3>${SystemLabelMap.OrderReturnItemsFromOrder} ${SystemLabelMap.CommonNbr}&nbsp;<a href="<@ofbizUrl>orderstatus?orderId=${orderId}</@ofbizUrl>" class="buttontext">${orderId}</h3></td>
                              <td align="right">
                                <span class="tableheadtext">${SystemLabelMap.CommonSelectAll}</span>&nbsp;
                                <input type="checkbox" name="selectAll" value="Y" class="selectAll"/>
                              </td>
                            </tr>
                            <tr>
                              <td><div class="tableheadtext">${SystemLabelMap.CommonDescription}</div></td>
                              <td><div class="tableheadtext">${SystemLabelMap.Quantity}</div></td>
                              <td><div class="tableheadtext">${SystemLabelMap.Price}</div></td>
                              <td><div class="tableheadtext">${SystemLabelMap.OrderReason}</div></td>
                              <td><div class="tableheadtext">${SystemLabelMap.OrderRequestedResponse}</div></td>
                              <td>&nbsp;</td>
                            </tr>
                            ...
                            <#if returnableItems?has_content>
                                  ...
                                  <td>
                                    <select name="returnTypeId_o_${rowCount}" class="selectBox">
                                      <#list returnTypes as type>
                                        <#if (type.returnTypeId == "RTN_REFUND") || (type.returnTypeId == "RTN_REPLACE")>
                              ...
                              <tr>
                                <td colspan="6"><div class="tableheadtext">${SystemLabelMap.OrderSelectShipFromAddress}:</td>
                              </tr>
                              <tr><td colspan="6"><hr /></td></tr>
                              <tr>
                                <td colspan="6">
                                      ...
                                      <tr>
                                        ...
                                        <td width="99%" valign="top" nowrap="nowrap">
                                          <div>
                                            ...
                                            <#--&nbsp;<a href="<@ofbizUrl>editcontactmech?DONE_PAGE=checkoutoptions&amp;contactMechId=${shippingAddress.contactMechId}</@ofbizUrl>" class="buttontext">[${SystemLabelMap.CommonUpdate}]</a>-->
                                          </div>
                                        </td>
                                      </tr>
                                    </#list>
                              ...
                              <tr>
                                <td colspan="6" align="right">
                                  <a href="javascript:document.selectAllForm.submit();" class="buttontext">${SystemLabelMap.OrderReturnSelectedItems}</a>
                                </td>
                              </tr>
                            <#else>
                              <tr><td colspan="6"><div>${SystemLabelMap.OrderNoReturnableItems} ${SystemLabelMap.CommonNbr}${orderId}</div></td></tr>
                            </#if>
                          </table>
                        </form>
                    </div>
