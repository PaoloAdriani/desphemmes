...
<#escape x as x?xml>
    ...
    <fo:table table-layout="fixed" width="100%" font-family="Monospaced" space-after="0.5in" space-before="0.5in">
          ...
          <fo:table-row>
            ...
            <fo:table-row>
                <fo:table-cell number-columns-spanned="2">
                    <fo:block font-weight="bold">${uiLabelMap.CommonDate}: ${mainOrderCreationDate?string["dd/MM/yyyy"]!}</fo:block> -
                </fo:table-cell>
            </fo:table-row>
          <fo:table-row>
              <fo:table-cell number-columns-spanned="2">
                  <fo:block font-weight="bold">${uiLabelMap.AccountingPayment}: ${mainOrderPaymentMethodDesc!}</fo:block> -
                  <fo:block font-size="10px">(${mainOrderPaymentMethodId!})</fo:block>
              </fo:table-cell>
          </fo:table-row>
        </fo:table-body>
    </fo:table>
    ...
    <fo:table table-layout="fixed" width="100%" space-before="0.1in" font-family="Monospaced">
    ...
    <fo:table table-layout="fixed" width="100%" space-before="0.2in" font-family="Monospaced">
    ...
    <fo:table-header height="10px" text-align="center" font-size="10pt">
      <fo:table-row border-bottom-style="solid" border-bottom-width="thin" border-bottom-color="black">
        <fo:table-cell>
          <fo:block font-weight="bold" padding-bottom="0.15in" text-align="left">${uiLabelMap.AccountingProduct}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold" padding-bottom="0.15in" text-align="left">${uiLabelMap.CommonDescription}</fo:block>
        </fo:table-cell> <fo:table-cell>
          <fo:block font-weight="bold" padding-bottom="0.15in" text-align="left">Color</fo:block>
        </fo:table-cell>
        <fo:table-cell>
    ...
    <fo:table-body font-size="10pt" font-family="Monospaced">
        ...
        <#list invoiceItems as invoiceItem>
            ...
            <#if !isItemAdjustment>
                ...
                <#assign colorDesc = "">
                <#assign sizeDesc = "">
                <#assign invoiceItemProductId = invoiceItem.productId!>
                <#if invoiceItemProductSizeColorMap??>
                    <#assign prdFeatureDescrMap = invoiceItemProductSizeColorMap.get(invoiceItemProductId)!>
                    <#if prdFeatureDescrMap??>
                        <#assign colorDesc = prdFeatureDescrMap.get("COLOR")!>
                        <#assign sizeDesc = prdFeatureDescrMap.get("TransactionProcessor.poolSize")!>
                    </#if>
               </#if>


                <fo:table-row height="14px" space-start=".15in">
                    <fo:table-cell padding-top="0.10in" padding-bottom ="0.10in" text-align="left">
                        <fo:block>${invoiceItem.productId!} </fo:block>
                    </fo:table-cell>
                    <fo:table-cell padding-top="0.10in" padding-bottom ="0.10in" text-align="left">
                        <fo:block>${description!}</fo:block>
                    </fo:table-cell>
                    <fo:table-cell padding-top="0.10in" padding-bottom ="0.10in" text-align="left">
                        <fo:block>${colorDesc!}</fo:block>
                    </fo:table-cell>
                      <fo:table-cell padding-top="0.10in" padding-bottom ="0.10in" text-align="center">
                        <fo:block> <#if invoiceItem.quantity??>${invoiceItem.quantity?string.number}</#if> </fo:block>
                    </fo:table-cell>
                    <fo:table-cell padding-top="0.10in" padding-bottom ="0.10in" text-align="center">
                        <fo:block> <#if invoiceItem.quantity??><@ofbizCurrency amount=invoiceItem.amount! isoCode=invoice.currencyUomId!/></#if> </fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right" padding-top="0.10in" padding-bottom ="0.10in">
            ...
            <#else>
                <#if !(invoiceItem.parentInvoiceId?? && invoiceItem.parentInvoiceItemSeqId??)>
                    <fo:table-row space-start=".15in">
                        ...
                        <fo:table-cell border-top-color="black"><fo:block/></fo:table-cell>
                        <fo:table-cell number-columns-spanned="4"><fo:block/></fo:table-cell>
                    </fo:table-row>
                </#if>

                <#-- @mpstyle nel caso di adjustment -->
                <#if itemType.description?contains("Promo") >
                    <#assign description = "Promotion">
                </#if>
                <#if itemType.description?contains("Shipping") >
                    <#assign description = "Shipping and Handling">
                </#if>

                <fo:table-row height="12px" space-start=".15in">
                    <fo:table-cell number-columns-spanned="2" padding-top="0.10in" padding-bottom ="0.10in">
                        <fo:block text-align="left">${description!}</fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right" number-columns-spanned="4" padding-top="0.10in" padding-bottom ="0.10in">
                        <fo:block> <@ofbizCurrency amount=(Static["org.apache.ofbiz.accounting.invoice.InvoiceWorker"].getInvoiceItemTotal(invoiceItem)) isoCode=invoice.currencyUomId!/> </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </#if>
        ...
        <fo:table-row>
           ...
           <fo:table-cell text-align="right" border-top-color="black" padding-top="0.10in" padding-bottom="0.10in">
